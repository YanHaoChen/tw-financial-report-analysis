...
class DateToolTestCase(unittest.TestCase):
    ...
    def test_date_to_ex_year_and_season_successfully(self):
    ...
    def test_season_to_ex_year_and_season_int_successfully(self):
        ex_year_and_season_int = DateTool.season_to_ex_year_and_season_int(20201)
        assert ex_year_and_season_int == 20194

    def test_to_tw_year_successfully(self):
        tw_year = DateTool.to_tw_year(2020)
        assert tw_year == 109

    def test_tw_year_to_year_successfully(self):
